...
Understanding dynamic libraries and how to create a dynamic libraries

TASKS
Creating a dynamic library
Task - Create the dynamic library libdynamic.so containing all the functions listed below:
...
CREATING A SCRIPT THAT CREATES A DYNAMIC LIBRARY
Task - Create a script that creates a dynamic library called liball.so from all the .c files that are in the current directory.
